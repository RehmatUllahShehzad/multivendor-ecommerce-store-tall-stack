...
class CreateAddressController extends AddressAbstract
{
    ...
    {
        return $this->view('frontend.customer.addresses.create-address-controller');
    }
    ...
    public function submit(AddressService $addressService)
    {
        ...
        try {
            ...
            session()->flash('alert-success', trans('notifications.address.created'));
