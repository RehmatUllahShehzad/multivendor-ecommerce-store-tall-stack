<div class="overflow-hidden shadow sm:rounded-md">
    <div class="flex-col px-4 py-5 space-y-4 bg-white sm:p-6">
            ...
            @if (auth()->user()->isAdmin())
                <div class="text-right">
                    <label class="inline-flex items-center cursor-pointer">
                        <span class="block mr-2 text-xs font-bold @if ($isAdmin) text-green-500 @else text-gray-400 @endif uppercase">
                            {{ __('global.admin') }}
                        </span>
        ...
        @else
            <ul role="list" class="mt-2 divide-y divide-gray-200 @if ($isAdmin) opacity-50 pointer-events-none @endif">
