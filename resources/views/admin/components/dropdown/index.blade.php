...
<div class="relative inline-block text-left"
    x-cloak x-data="{ menuOpen: false }"
    @click.outside="menuOpen = false"
    @close-menu-popup.window="menuOpen = false"
>
    <div>
        @if ($minimal)
    ...
    <div
        class="absolute {{ $position == 'right' ? 'left-0' : 'right-0' }} top-0 z-50 w-56 mt-2 origin-top-right bg-white rounded-md shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
        role="menu"
