<div class="inner-section">
    ...
    data-gjs-propagate='["removable", "copyable", "draggable", "droppable"]'>
        <div class="whats-new-banner"
         style="background-image: url(/frontend/images/whats-new-banner.png) , linear-gradient(rgba(0,0,0,0.15),rgba(0,0,0,0.15));;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
    ...
    data-gjs-propagate='["removable", "copyable", "draggable", "droppable"]'>
        ...
        <div class="terms-policy">
                <p>Last Updated on 01-Jul-2022</p> 
                <p>NOTICE: Please read the terms and conditions set forth below, which are legally binding.
                    ...
                    Policy and Disclaimer.</p>
                <p>PLEASE READ THE SECTIONS TITLED “BINDING ARBITRATION” AND “CLASS ACTION
                    WAIVER” AS THEY AFFECT YOUR LEGAL RIGHTS.</p>
                <p>
                    People's Pantry, which is operated by People's Pantry (“Company”, “we”, “us”, or “our”)
                    provides visitors information on www.shoppeoplespantry.com (“website”) subject to the
                ...
                <h3>United States AND OVER 18 USE ONLY</h3>
                <p>The website is intended only for individuals over the age of 18 residing in the United
                ...
                <ul>
                    ...
                    <li>You will not upload, post, send, email, or otherwise make available any
                ...
                <ul>
                    <li>Our Intellectual Property must be kept intact with the proper copyright and other
                    intellectual property notices; and</li>
                    <li>You may not reproduce, resell, distribute, publicly perform, create derivative
                    ...
                    received explicit written consent from us to do so.</li>
                </ul>
                <p>
                ...
                applicable fees and taxes. It is your responsibility to provide complete, accurate and up-
                to-date billing and credit card information. If you are on a payment plan or recurring
                ...
                <p>
                    ...
                    our Products. If you are not satisfied with a Product, please contact us within 2 days of
                    your purchase and we will gladly issue you a full refund.
                </p>
                ...
                <p>
                    The arbitration proceedings shall be held in Abilene, Texas, United States of America in
                ...
                <h3>INJUNCTIVE OR OTHER EQUITABLE RELIEF</h3>
                <p>
                ...
                <p>This Agreement, the Privacy Policy and Disclaimer contain the entire agreement
                ...
                <p>We reserve the right, in our sole discretion, to terminate this Agreement and to terminate,
                    restrict, deny, or suspend your access to the website and all Products at any
                ...
                <h3>SEVERABILITY</h3>
                <p>If any term or other provision of this Agreement is held to be invalid, prohibited or
                    unenforceable under applicable law, the other provisions of this Agreement will remain
                    in full force and effect.
                </p>

                <h3>MISCELLANEOUS</h3>
                <p>Our failure to act on or delay in exercising any privilege, power or right under this
                ...
                <p>Subheadings in this Agreement are used for convenience of reference only and in no
                ...
                <p>The terms and conditions of this Agreement shall inure to the benefit of and be binding
                ...
                <p>If any action at law or in equity is necessary to enforce or interpret the terms of this
                ...
                <p>By email: <a href="mailto:support@shoppeoplepantry.com">support@shoppeoplepantry.com</a></p>
                <p>By contact form: <a href="https://shoppeoplespantry.com/contact" target="_blank"> www.shoppeoplespantry.com/contact</a></p>
