        ...
        <div class="personal-messages">
            ...
            @if ($conversation)
                @foreach ($messages as $message)
                    @include('frontend.customer.message._partials.message-row', ['message' => $message, 'order_number' => $orderPackage->order->order_number])
                @endforeach
            ...
            @else
                @include('frontend.customer.message._partials.empty', ['message' => 'Conversation not started yet!'])
            @endif
        </div>
    </div>
</div>
